...
-- Resposta: ano (2022) id(49) nome(João Pedro da Luz) qtd_pedidos (381)
-- Resposta: ano (2023) id(76) nome(Lívia Farias) qtd_pedidos (524)
-- Resposta: ano (2024) id(1) nome(Ana Laura Casa Grande) qtd_pedidos (281)
...
join
    tb_pedido pd on m.codigo_mesa = pd.codigo_mesa
join
...
-- Resposta: ano (2022) id_cliente (49) nome_cliente (João Pedro da Luz) total_gasto (12345.67)
